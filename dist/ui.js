class UI {
    ...
    paintNextLaunchDetails(item) {
        ...
        div.innerHTML = `
            <p>
            <span class="details-title">Launch Time (Your) :</span>&nbsp;&nbsp;${moment(item.launch_date_local).format('llll')} <br/>
            <span class="details-title">Launch Time (Site) : </span>&nbsp;&nbsp;  ${moment.parseZone(item.launch_date_local).format('llll')}
            </p>
            <p>
            ...
            <p>
            <span class="details-title">Rocket Type : </span>&nbsp; ${item.rocket.rocket_name} <br/ >
            <span class="details-title">Rocket Payload : </span>&nbsp; ${item.rocket.second_stage.payloads[0].payload_type} <br/ >
